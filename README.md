...
- Пользовательские курсы валют — возможность задать свой курс валют. Курс сохраняется локально и используется для замены цен на AV.by и в конвертере. Сбрасывается при обновлении курсов из НБРБ.
