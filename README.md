...
- Опциональная функция VIN (по умолчанию выключена): может подставлять полный VIN в карточке авто и отправлять уже открытый VIN в Worker для подтверждений сообщества.
