...
Popup UI in `src/popup/`. This is the extension action popup shown to users for rates, conversion, display-currency selection, manual refresh, and the optional VIN toggle.
...
└── popup.js           # DOM controller, rates rendering, storage, messages to background
```
